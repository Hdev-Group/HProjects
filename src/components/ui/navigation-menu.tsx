...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-colors  hover:text-neutral-50  focus:text-neutral-50 focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:text-neutral-50 data-[state=open]:text-neutral-50 dark:focus:text-neutral-50 dark:data-[active]:text-neutral-50 dark:data-[state=open]:text-neutral-50"
)
