...
export default function DarkChat({assigneeData, message}: {assigneeData: any, message: string}) {
    ...
    return(
        <div className="flex  justify-start flex-row items-end gap-4 rounded-md px-1 py-2 dark:hover:bg-neutral-900 hover:bg-neutral-200/20">
            ...
            <div className="flex flex-col gap-[4px]">
                ...
                <div className="w-full px-5 py-2 relative mb-2.5 rounded-sm items-end justify-end h-auto bg-neutral-800 z-30 max-w-[90%]">
