    ...
    const renderDropZone = ({status, name}: {status: string, name: string}) => (
        ...
        >
            <div className="mt-2 flex items-center gap-2 mb-4 pb-2">
                <h2 className="text-lg font-semibold text-black dark:text-white capitalize flex flex-row items-center gap-2 justify-center"><img src={dropzoneimages[name]} width={25} height={5} />{name}</h2>
