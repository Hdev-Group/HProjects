...
export default function HeaderLinker({_id, currentpage}: { _id: any, currentpage: string }) {
    return(
        ...
        <div className='w-16 items-center justify-center flex flex-row relative'>
            <Link href={`/projects/${encodeURI(_id)}/project-settings/`} className={`${currentpage === "project" ? "text-white" : "text-neutral-500"} w-full items-center justify-center flex`}>
                <p>Project</p>
            ...
            <Link href={`/projects/${encodeURI(_id)}/project-settings/team`} className={`${currentpage === "team" ? "text-white" : "text-neutral-500"} w-full items-center justify-center flex`}>
            <p>Team</p>
            ...
            <Link href={`/projects/${encodeURI(_id)}/project-settings/personal`} className={`${currentpage === "personal" ? "text-white" : "text-neutral-500"} w-full items-center justify-center flex`}>
                <p>Personal</p>
            ...
            <Link href={`/projects/${encodeURI(_id)}/project-settings/danger`} className={`${currentpage === "danger" ? "text-red-300" : "text-neutral-500"} w-full items-center justify-center flex`}>
                <p>Danger Zone</p>
