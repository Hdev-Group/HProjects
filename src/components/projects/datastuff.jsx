    ...
    <>
      {pinnedProjects.length > 0 && (
        <div className="flex flex-col gap-4">
          <h2 className="text-2xl text-black dark:text-white font-bold flex flex-row flex-wrap  w-full items-center gap-3">
      ...
      <div className="flex flex-col gap-4 w-full ">
        <h2 className="text-2xl font-bold flex flex-row flex-wrap text-black dark:text-white w-full items-center gap-3">
