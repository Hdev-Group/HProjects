...
export default function CommentBox({ taskId, _id }: CommentBoxProps) {
    ...
    return (
        <div className='border-dashed border p-4 flex gap-4 flex-col justify-center rounded-md hover:border-neutral-200 transition-all'>
            <textarea
                className='p-2 w-full rounded-md min-h-[5rem] border border-neutral-700 bg-transparent'
                id='descriptioner'
            ...
            />
            <button
                className={` hover:bg-neutral-500/60 transition-all p-2 max-w-[10rem] rounded-md ${
